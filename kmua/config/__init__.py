...
"""
    agent_affection_prompts: dict[float, str] = {
        ...
        0.3: "你与用户的关系有些疏远, 你对用户的好感较低.",
        0.1: "你与用户的关系较为疏远, 你对用户的好感较低, 你与用户的互动应当缺乏兴趣和积极性.",
        0.02: "你与用户的关系非常差, 你们之间几乎没有任何感情, 甚至有些敌意, 你对用户的好感非常低, 你与用户的互动常常表现出冷漠或不耐烦.",
    }
    ############################################################################
